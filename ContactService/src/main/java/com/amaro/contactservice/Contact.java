...
public class Contact {
    ...
    public Contact(String contactID, String firstName, String lastName, String phone, String address) {
        ...
        if (contactID == null || contactID.length() > 10) {
            throw new IllegalArgumentException("Invalid contact ID. Must not be null and max length is 10 characters.");
        }
        this.contactID = contactID;

        // Validate and assign firstName
        if (firstName == null || firstName.length() > 10) {
            throw new IllegalArgumentException("Invalid first name. Must not be null and max length is 10 characters.");
        }
